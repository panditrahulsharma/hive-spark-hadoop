...
## [connect spark with hive](https://www.youtube.com/watch?v=eXDRx2c-VP4)
steps:
1. enter hive docker image and copy hive-site.xml
  $   docker exec -it hive-server bash

  go to conf dir and copy hive-site.xml

  $ docker cp rahul_config/hive-site.xml spark-master:/spark/conf


2. download postgres jar file
 $ wget https://mvnrepository.com/artifact/org.postgresql/postgresql/42.2.19

  $ docker cp rahul_config/psostgre.jar spark-master:/spark/jars
